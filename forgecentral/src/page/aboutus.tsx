      ...
      >
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-10 items-center relative z-10">
          ...
          <div className="flex-1 relative w-full max-w-[490px] flex flex-col items-center mt-8 md:mt-0">
            ...
            {/* Floating Info Box */}
            <div className="absolute z-30 w-[180px] h-[130px] left-[-10px] bottom-[-10px] md:w-[262px] md:h-[200px] md:left-[-40px] md:bottom-[-20px]">
              {/* Outer blue card with shadow */}
              <div className="bg-[#030E4D] flex flex-col items-center shadow-2xl shadow-gray-400/40 w-[170px] h-[120px] pt-3 pb-3 relative md:w-[252px] md:h-[235px] md:pt-6 md:pb-6 rounded-[20px] md:rounded-[32px]">
                {/* White floating content fully inside blue */}
                <div className="bg-white shadow-lg flex flex-col gap-2 z-10 absolute top-1 left-1 w-[155px] h-[80px] p-2 rounded-[14px] flex justify-center md:top-[7px] md:left-[6px] md:w-[240px] md:h-[153px] md:p-6 md:rounded-[24px]">
                  {[
                    ...
                    <div
                      key={idx}
                      className="flex items-center gap-1 pl-1 md:gap-4 md:pl-4"
                    >
                      <Image
                        src={item.icon}
                        width={16}
                        height={12}
                        alt="arrow"
                        className="w-[16px] h-[12px] md:w-[32px] md:h-[24px]"
                      />
                      <span className="text-[#101B5A] font-semibold text-xs md:text-lg tracking-tight">
                        {item.text}
                      </span>
                    </div>
                  ))}
                ...
                <div className="flex justify-center items-center absolute left-1/2 -translate-x-1/2 bottom-1 md:bottom-[10px]">
                  <Image
                    src="/aboutus_bottom_logo.svg"
                    width={40}
                    height={18}
                    alt="footer icon"
                    className="w-[40px] h-[18px] md:w-[104px] md:h-[48px]"
                  />
                </div>
              </div>
            </div>
      ...
      >
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-12 lg:gap-20">
          ...
          <div className="flex-1 w-full flex flex-col justify-between h-full px-0 sm:px-2 md:px-0">
            ...
            {/* LinkedIn button */}
            <div className="flex flex-row items-center gap-4 mt-3 justify-center md:justify-start">
              <Link
      ...
      <section className="bg-[#f4f5f7] py-16 px-4 md:px-24" ref={coreValuesRef}>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 text-center md:text-left">
            ...
            <div className="h-2 mt-1 mb-3 flex justify-center md:justify-start ml-0 md:ml-20">
              <Image
                src="/aboutus_Line_34.svg"
                alt="underline icon"
                width={45}
