  ...
  return (
    <>
      ...
      <div className="w-full bg-white item-center justify-center">
        ...
        <section className="w-full bg-white px-4 md:px-8 pt-16 pb-0">
          <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row-reverse items-stretch md:items-center gap-8 md:gap-16">
            {/* Left: Content */}
            <div className="w-full md:basis-1/2 md:max-w-[50%] flex flex-col items-start text-left justify-center">
              {/* Icon */}
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center mb-4 bg-[#FFF5E0] sm:mb-5">
                <img
              ...
              {/* Heading */}
              <h2 className="text-[28px] md:text-[30px] font-extrabold text-[#E29400] mb-4 sm:mb-2 sm:text-[30px]">
                Infrastructure Services
              </h2>
              {/* Description */}
              <p className="text-[#535353] text-lg md:text-[18px] font-medium leading-relaxed mb-6 sm:mb-6">
                Our infrastructure services are built for enterprises with demanding
                <span className="font-bold text-[#161616]">
                  {" "}
                  compute needs, mission-critical workloads, and evolving IT landscapes
                </span>
                —whether in the cloud, on-premise, or hybrid.
              </p>
              {/* Feature List */}
              <div className="w-full mt-6 mb-2">
                <div className="flex flex-col md:flex-row md:flex-wrap gap-y-4 md:gap-x-6 items-start md:items-center justify-start w-full">
                  {/* Performance-Driven */}
            ...
            {/* Right: Image */}
            <div className="w-full md:basis-1/2 md:max-w-[50%] flex justify-center relative mt-8 md:mt-0">
              {/* Blurred Ellipse */}
              <div className="absolute w-[200px] h-[200px] bg-[#E29400] opacity-90 blur-[150px] rounded-full rotate-[30deg] bottom-0 left-1/2 -translate-x-1/2 md:left-[-80px] md:translate-x-0 z-0" />
              <img
                src="/infrastructure_services_image.svg"
                alt="Infrastructure Security"
                className="w-full max-w-[340px] md:max-w-[540px] h-auto object-contain relative z-10 min-w-[200px] min-h-[120px] sm:min-w-[340px] sm:min-h-[200px]"
              />
            </div>
          </div>
        </section>
        ...
        >
          <div className="max-w-[1200px] mx-auto flex flex-col items-center">
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-2 sm:px-8 md:px-20 justify-center">
              {/* Card 1 */}
              <div
                className="flex flex-col bg-white rounded-3xl px-7 py-8 w-full max-w-[330px] h-[296px] flex-1 mx-auto items-start transform transition-transform duration-300"
                style={{
