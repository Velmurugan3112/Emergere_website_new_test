...
const services = [
  ...
  },
  {
    ...
    title: "ERP",
    description:
      "Empower businesses to streamline operations and boost performance with scalable ERP solutions and real-time insights.",
    icon: "/erp_icon.png",
    href: "/erp-services",
    color: "bg-gradient-to-b from-[#215EF8]-600 to-[#023ED6]-400",
  },
          ...
          <div className="relative text-white px-0 md:px-0 h-full flex items-stretch overflow-hidden pointer-events-auto">
            ...
            >
              <div className="w-full max-w-3xl flex flex-col items-center md:items-start text-center md:text-left md:mx-0">
                ...
                <p className="text-md text-[#FFFFFF] mb-8 w-full max-w-xl mx-auto md:mx-0">
                ...
                <Link href="#what-we-do">
                  <button className="flex items-center gap-x-2 bg-white text-[#023ED6] font-semibold px-6 py-3 rounded-full shadow hover:scale-105 transition outline outline-2 outline-[#023ED6] mx-auto md:mx-0">
                    Explore More
                    <img
      ...
      >
        ...
        <div className="relative px-4 sm:px-6 md:px-10 z-10">
          ...
          <div className="max-w-7xl mx-auto py-10 md:py-20 flex flex-col md:flex-row items-center md:items-start gap-10 md:gap-20 lg:gap-40 relative z-10">
            ...
            {/* Content Block */}
            <div className="w-full md:w-1/2 text-center md:text-left mt-8 md:mt-0 z-10 flex flex-col items-center md:items-start">
              <p className="text-xs sm:text-sm md:text-md uppercase font-bold text-blue-700 mb-2 tracking-wider inline-block relative">
                WHO WE ARE
                <span className="absolute bottom-0 right-0 translate-y-full w-8 sm:w-10 h-1 bg-[#FFA700] rounded mt-1"></span>
              </p>

              <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              ...
              <p className="text-[#535353] text-md sm:text-md md:text-lg mb-4">
              ...
              <div className="grid grid-cols-2 gap-y-2 gap-x-4 sm:gap-x-8 text-[#000000] text-md sm:text-md md:text-md font-bold mb-4 w-full max-w-xs sm:max-w-sm md:max-w-none mx-auto md:mx-0">
              ...
              <p className="text-[#535353] text-md sm:text-md md:text-lg mb-8">
        ...
        <div className="relative bg-gradient-to-r from-[#023ED6] to-[#002FA7] overflow-hidden py-0 px-0">
          ...
          />
          <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-4 sm:px-6 md:px-20 py-12 md:py-16 gap-8 md:gap-0">
            {/* Left: Icon + Heading */}
            <div className="flex flex-col sm:flex-row items-center sm:items-end gap-4 sm:gap-6 md:w-1/2 text-center sm:text-left">
              <img
                src="/transforming_insights_icon.png"
                alt="Insight Icon"
                className="w-20 h-20 md:w-24 md:h-24 mx-auto sm:mx-0"
              />
              <h2 className="text-white text-2xl sm:text-3xl md:text-3xl font-bold leading-tight mt-4 sm:mt-0">
                Transforming <br className="hidden sm:block" />
                Insights into <br className="hidden sm:block" />
                Impact
              </h2>
            </div>
            {/* Divider: horizontal on mobile, vertical on md+ */}
            <div
              className="w-full h-0.5 bg-gradient-to-r from-[#0028B0] via-[#7E94D9] to-[#002BB4] my-6 md:my-0 md:w-0.5 md:h-32 md:bg-gradient-to-b md:from-[#0028B0] md:via-[#7E94D9] md:to-[#002BB4] md:mx-10"
        ...
        <div className="bg-[#f7f7f7] py-10 px-6 md:px-24 text-center">
          ...
          {/* Brochure Section */}
          <div className="mt-20 relative rounded-[40px] overflow-hidden px-4 sm:px-10 md:px-20 py-10 md:py-16 flex flex-col md:flex-row items-center justify-between gap-8 bg-[#F2F2F2]">
            ...
            <div className="z-10 flex-1 text-center flex flex-col items-center">
              ...
              <br />
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-black leading-snug mb-6 text-center md:text-start">
            ...
            <div className="z-10 flex-1 flex justify-center relative mt-8 md:mt-0 w-full md:w-auto">
              <div className="relative w-60 h-60 sm:w-56 sm:h-56 md:w-72 md:h-72 z-10 flex items-center justify-center">
                <img
                  src="/Brochure.png"
                  alt="Brochure Icon"
                  className="w-full h-full object-contain z-10 relative mx-auto md:mx-0"
                />
              </div>
            </div>
          </div>
